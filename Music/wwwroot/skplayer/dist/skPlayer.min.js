        ...
        function () {
                ...
                var s = {
                    leftDistance: function (t) {
                        for (var e = t.offsetLeft,
                            n = void 0; t.offsetParent;) t = t.offsetParent,
                                e += t.offsetLeft;
                    ...
                    l = function () {
                        function t(e) {
                            ...
                            if (this.option = e, !(this.option.music && this.option.music.type && this.option.music.source)) return console.error("请正确配置对象！"),
                                Object.create(null);
                            this.root = this.option.element,
                                ...
                                "file" === this.type ? (this.root.innerHTML = this.template(), this.init(), this.bind()) : "cloud" === this.type && (this.root.innerHTML = '<p class="skPlayer-tip-loading">LOADING</p>', s.ajax({
                                    ...
                                    success: function (t) {
                                        console.log("歌单拉取成功！"),
                                            n.music = JSON.parse(t),
                                            n.root.innerHTML = n.template(),
                                            n.init(),
                                            n.bind()
                                    },
                                    fail: function (t) {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                this.dom = {
                                    ...
                                    this.option.listshow && (this.root.className = "skPlayer-list-on"),
                                    "singleloop" === this.option.mode && (this.audio.loop = !0),
                                    this.dom.musicitem[0].className = "skPlayer-curMusic",
                                    "cloud" === this.type && s.ajax({
                            ...
                            value: function () {
                                ...
                                this.updateLine = function () {
                                    ...
                                    this.audio.addEventListener("durationchange",
                                        function (e) {
                                            t.dom.timetext_total.innerHTML = s.timeFormat(t.audio.duration),
                                                t.updateLine()
                                        }),
                                    ...
                                    this.audio.addEventListener("timeupdate",
                                        function (e) {
                                            ...
                                            t.dom.timeline_played.style.width = s.percentFormat(n),
                                                t.dom.timetext_played.innerHTML = s.timeFormat(t.audio.currentTime)
                                        }),
                                    ...
                                    this.isMobile || this.dom.volumebutton.addEventListener("click", this.toggleMute),
                                    this.dom.modebutton.addEventListener("click", this.switchMode),
                                    this.dom.musiclist.addEventListener("click",
                                        function (e) {
                                            console.log(e);
                                            ...
                                            o = parseInt(n.getAttribute("data-index")),
                                                r = parseInt(t.dom.musiclist.querySelector(".skPlayer-curMusic").getAttribute("data-index")),
                                                o === r ? t.play() : t.switchMusic(o + 1)
                                            console.log('当前播放的:' + r);
                                            console.log('选中想要播放的:' + o);
                                        }),
                                    this.dom.timeline_total.addEventListener("click",
                                        function (e) {
                                    ...
                                    this.isMobile || this.dom.volumeline_total.addEventListener("click",
                                        function (e) {
                                            var n = e || window.event,
                                                o = (n.clientX - s.leftDistance(t.dom.volumeline_total)) / t.dom.volumeline_total.clientWidth;
                                            t.dom.volumeline_value.style.width = s.percentFormat(o),
                                                t.audio.volume = o,
                                                t.audio.muted && t.toggleMute()
                                        })
                            }
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                return "number" != typeof t ?
                                    void console.error("请输入正确的歌曲序号！") :
                                    (t -= 1) < 0 || t >= this.music.length ?
                                        void console.error("请输入正确的歌曲序号！")
                                        : t == this.dom.musiclist.querySelector(".skPlayer-curMusic").getAttribute("data-index")
                                            ? void this.play() : (this.dom.musiclist.querySelector(".skPlayer-curMusic").classList.remove("skPlayer-curMusic"),
                                                this.dom.musicitem[t].classList.add("skPlayer-curMusic"),
                                                this.dom.name.innerHTML = this.music[t].name,
                                                this.dom.author.innerHTML = this.music[t].author,
                                                this.dom.cover.src = this.music[t].cover,
                                                void ("file" === this.type ? (this.audio.src = this.music[t].src, this.play())
                                                    : "cloud" === this.type && s.ajax({
                        ...
                        },
                        {
                            ...
                            value: function () {
                                //当前播放
                                let curIndex = parseInt(this.dom.musiclist.querySelector(".skPlayer-curMusic").getAttribute("data-index"));
                               
                                if (this.music[curIndex].lyric === null) {
                                    console.log('歌词还在路上');
                                    $('#lyricContainer').text('歌词还在路上~');
                                    // <ul id="lyricContainer"></ul>
                                } else {
                                    //滚动歌词
                                    var m = new MusicPlayer({
                                        lyric: this.music[curIndex].lyric,
                                ...
                                var _na = this.music[curIndex].name;
                                if (_na) {
                                    document.getElementsByTagName("title")[0].innerText = _na;
                                }
            ...
            function (t, e, n) {
                ...
                function d(t, e, n, o) {
                    ...
                    if (t.styleSheet) t.styleSheet.cssText = v(e, r);
                        ...
                        i[e] && t.removeChild(i[e]),
                            i.length ? t.insertBefore(s, i[e]) : t.appendChild(s)
                    }
                }
                function p(t, e) {
                    var n = e.css,
                ...
                function h(t, e, n) {
                    var o = n.css,
                        r = n.sourceMap,
                        s = void 0 === e.convertToAbsoluteUrls && r; (e.convertToAbsoluteUrls || s) && (o = g(o)),
